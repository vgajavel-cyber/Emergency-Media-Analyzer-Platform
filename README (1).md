...
| Emergency Report Form | Admin Dashboard |
|---|---|
| ![Emergency Report](Screenshot_2026-04-18_195810.png) | ![Admin Dashboard](Screenshot_2026-04-18_195855.png) |

> **Report Form** — Auto-detects location (Tempe, Arizona), 4-step guided flow, AI suggestions, and media upload.

> **Admin Dashboard** — 25 total reports, verified incidents, AI calls made, status management with one click.
